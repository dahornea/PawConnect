    ...
    IAuditLogService? auditLogService = null) : IAdoptionCopilotService
{
    ...
    private static AdoptionCopilotDogToolDto ToDogDto(AdoptionCopilotToolDogCandidate candidate)
    {
        ...
        return new AdoptionCopilotDogToolDto(
            ...
            dog.Size.ToString(),
            dog.Status.ToString(),
            DogCompatibilityFormatter.FormatCat(dog.CatCompatibility),
            DogCompatibilityFormatter.FormatDog(dog.DogCompatibility),
            DogCompatibilityFormatter.FormatChildren(dog.ChildrenCompatibility),
            DogCompatibilityFormatter.FormatActivity(dog.ActivityLevel),
            DogCompatibilityFormatter.FormatExperience(dog.ExperienceNeeded),
            DogCompatibilityFormatter.FormatApartment(dog.ApartmentSuitability),
