...
public partial class ShelterNaturalLanguageSearch
{
    ...
    [
        "My pending requests",
        "My dogs reserved for more than 10 days",
    ...
    private async Task SearchAsync()
    {
        ...
        try
        {
            ...
            {
                _error = "The current shelter account could not be resolved.";
                return;
            }

            _result = await NaturalLanguageSearchService.SearchShelterAsync(
        ...
        {
            _error = "Shelter operational search could not be completed right now.";
    ...
    private static Color GetStatusColor(string? status)
    {
        ...
        if (status.Contains("Available", StringComparison.OrdinalIgnoreCase) ||
            ...
            status.Contains("In stock", StringComparison.OrdinalIgnoreCase))
        {
